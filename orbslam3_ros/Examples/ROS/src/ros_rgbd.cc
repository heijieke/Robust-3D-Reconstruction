...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(nh, "/camera/rgb/image_color", 100);//"/camera/rgb/image_raw"
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/camera/depth/image", 100);//"camera/depth_registered/image_raw"
